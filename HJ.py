...
startpt = [2,5]
itermax = 5000
steplength = 0.5        # a user-supplied convergence parameter which should be set to a value between 0.0 and 1.0.
...
if showStartAndEnd:
    ...
    endPointText = [plt.text(endpt[0], endpt[1],'   Minimum (' + str(np.round(endpt[0],2)) + ',' + str(np.round(endpt[1],2)) + ')')]
